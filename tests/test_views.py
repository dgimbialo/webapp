...
class Test_view_wiki:
    def _callFUT(self, request):
        from webapp.views.default import view_wiki
...
class Test_view_page:
    def _callFUT(self, request):
        from webapp.views.default import view_page
        return view_page(request)

    def _makeContext(self, page):
        from webapp.routes import PageResource
...
class Test_add_page:
    def _callFUT(self, request):
        from webapp.views.default import add_page
        return add_page(request)

    def _makeContext(self, pagename):
        from webapp.routes import NewPage
...
class Test_edit_page:
    def _callFUT(self, request):
        from webapp.views.default import edit_page
